(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("@eshaz/web-worker"))
    : typeof define === "function" && define.amd
    ? define(["exports", "@eshaz/web-worker"], factory)
    : ((global =
        typeof globalThis !== "undefined" ? globalThis : global || self),
      factory((global["opus-decoder"] = {}), global.Worker));
})(this, function (exports, NodeWorker) {
  "use strict";
  ...
  const t = (t, n = 4294967295, e = 79764919) => {
    ...
    e = (n, e = t) => {
      const r = (t) =>
          new Uint8Array(t.length / 2).map((n, e) =>
            parseInt(t.substring(2 * e, 2 * (e + 1)), 16)
          ),
        o = (t) => r(t)[0],
        s = new Map();
      [
      ...
      let c,
        ...
        g = 0,
        h = 42,
        p = n.length > 13 && "dynEncode" === n.substring(0, 9),
        u = 0;
      p &&
        ((u = 11),
        (a = o(n.substring(9, u))),
        a <= 1 && ((u += 2), (h = o(n.substring(11, u)))),
        1 === a &&
          ((u += 8),
          (l = ((t) => new DataView(r(t).buffer).getInt32(0, !0))(
            n.substring(13, u)
          ))));
      const d = 256 - h;
      for (let t = u; t < n.length; t++)
        if (((c = n.charCodeAt(t)), 61 !== c || f)) {
          if (92 === c && t < n.length - 5 && p) {
            const e = n.charCodeAt(t + 1);
            (117 !== e && 85 !== e) ||
              ((c = parseInt(n.substring(t + 2, t + 6), 16)), (t += 5));
          }
          if (c > 255) {
            const t = s.get(c);
            t && (c = t + 127);
        ...
        inflateDynEncodeString: {
          value(source) {
            ...
            return new Promise((resolve) => {
              ...
              WASMAudioDecoderCommon.getModule(
              ...
              self.onmessage = ({ data: { id, command, data } }) => {
                ...
                if (command === "init") {
                  ...
                  transferList = messagePayload.channelData
                    ? messagePayload.channelData.map(
  ...
  function EmscriptenWASM(WASMAudioDecoderCommon) {
    ...
    if (!EmscriptenWASM.wasm)
      Object.defineProperty(EmscriptenWASM, "wasm", {
...
R>XþÛz Ûªöt\ï£+|½ »XP÷QVÈû³JºÆ+Y÷9Z}¥@¾Ý= ÿcAÜ'£³æpóCèA^5£Ë)öt[zçHÍÞQá!+£³æpqE'¨Záª2{ürÞn¬£ÔwYßÛä\7TÃa"yRSIbâmiÖZñµ=M£2]ÑqøG}Ò`,
    ...
    var _opus_frame_decoder_create,
      _malloc,
